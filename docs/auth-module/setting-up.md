...
In this day and age, your can not ship a website with clunky feeling authentication. Your users deserve a email and password (standard, especially security conscious users who do not like linking accounts), sign-up and sign-in via magic links ( the growing favorite for its convenience) and social login options like Google, Meta, GitHub, etc. <br>

This Auth module is going to help you get a secure authentication up and running in efficiently  including pages/views that you can easily customize if you desire too.
...
First step to get authentication and authorization is to simply connect to a database to actually store our user data. Since ApexKit ships with the wonder Better Auth, nor  you  are not locked into any service like Okta or Clerk and neither you need to write roll-out your own authentication from scratch and spend your time writing hashing, salting and all the crucial pieces of authentication. \
\
...
* EMAIL\_API\_KEY This will take care of sending emails for verification and magic links.
...
This kit ships with a Better-Auth compatible authentication schema with user, session, account, verification tables.  You can modify this table and add as many fields according to your own restrictions and flexibility as long you provide the core fields that Better-Auth needs to help roll-out a secure authentication.
...
\
In order to move forwards, once you have settled on you `auth` schema (stick to the default or update according to your needs), we need to validate and push it to our database.\
\
...
\
This kit have simple scripts to make easier for you to perform these operations.
...
Some familiarity with SQL and Relational Databases would be helpful here. But if you haven't worked with them before, its okay. This kit will reduce overhead significantly and you can pick-it as you go you would like to.
